      ...
      <div className=" flex flex-col gap-10">
        <div>
          <div className="w-[100vw] justify-start flex flex-col gap-5">
            <div className=" py-5">
              <div className="text px-[15px] sm:px-[25px] md:px-[50px]">
                <h1 className="text-left text-black text-lg font-bold">
              ...
              <div className=" courses-grid-containerr mb-5 px-2 sm:px-[25px] md:px-12 py-8">
